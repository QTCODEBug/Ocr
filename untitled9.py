...
Original file is located at
    https://colab.research.google.com/drive/1IsEsmkotyI1YneYGwSeRCDAKKo3BHUKJ
"""
...
img = cv2.imread('/content/drive/MyDrive/OCR/anhdonghh.jpg', 0)
...
model.save('letter.tflearn')

model.load('letter.tflearn')
